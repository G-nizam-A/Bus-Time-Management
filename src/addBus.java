...
public class addBus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8_menu_48px_1.png"))); // NOI18N
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, -1));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/adddriver.png"))); // NOI18N
        ...
        jPanel7.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 50));
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bus_1.png"))); // NOI18N
        jLabel19.setText("     Add Bus Details");
        jPanel10.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));
        ...
        jPanel14.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String BusName=jTextField2.getText();
        String DriverID=jTextField3.getText();
        try
        {
            ...
            while(rs.next())
                BusID=rs.getInt(1);
            BusID++;
            st.executeUpdate("insert into bus values('"+BusID+"','"+BusNumber+"','"+BusName+"','"+DriverID+"')");
    ...
    private void jTextField2FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField2FocusLost
       ...
       /* if(jTextField2.getText().equals(""))
        {
            jTextField2.setText("Enter Bus ID");
