...
public class adminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("BUS TIME MANGEMENT");
        ...
        jCheckBox7.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 67, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try
            ...
            ResultSet rs=st.executeQuery("select *from admin where adminName='"+Name+"' and password='"+password+"'");
