...
public class editBus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 30, -1, -1));
        ...
        jLabel18.setText("    EDIT BUS DETAILS");
        ...
        jButton4.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 16)); // NOI18N
        jButton4.setText("Deleted Bus");
        ...
        getContentPane().add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 80, 1000, -1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        String BusID1=jTextField4.getText();
        String BusID=jTextField1.getText();
        String BusNumber=jTextField2.getText();
        String BusName=jTextField3.getText();
        String DNo=jTextField5.getText();
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            st.executeUpdate("update bus set BusID='"+BusID+"',BusNumber='"+BusNumber+"',BusName='"+BusName+"', DNo='"+DNo+"' where BusID='"+BusID1+"'");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String BusID=jTextField4.getText();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select * from bus where BusID='"+BusID+"'");
            if(rs.next())
            {
            ...
            {
                JOptionPane.showMessageDialog(null, "Bus Number Does Not Exists");
            }
        }
        catch(Exception e)
        {
